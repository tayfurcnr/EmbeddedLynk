...
// MODULE UART
#define MODULE_UART_TYPE     UART_TYPE_HARDWARE   // Donanımsal
#define MODULE_UART_PORT     UART_NUM_1           // Kullanılmayabilir, ama tanımlı kalsın
#define MODULE_UART_TX_PIN   16
#define MODULE_UART_RX_PIN   17

// USER UART
#define USER_UART_TYPE       UART_TYPE_HARDWARE
